import unittest
from CodingPractice.PythonAssignments.cleancode.DateUtils import weekdays_in_range
...
class DateCalculatorTests(unittest.TestCase):
    ...
    def test_00_number_of_days_between(self):
        ...
        self.assertEqual(15, weekdays_in_range(start, end))
    ...
    def test_02_one_week_count(self):
        ...
        self.assertEqual(5, weekdays_in_range(start, end))
    ...
    def test_04_mid_week(self):
        ...
        self.assertEqual(10, weekdays_in_range(start, end))
