import unittest
from CodingPractice.PythonAssignments.shoppingcart.ProductJsonDao import *


class TestProductJsonDao(unittest.TestCase):

    def test_00_get_products(self):
        expected = ProductDto(1, 'StandardWidget', 5.1, 100, 10000)
        p = ProductJsonDao()
    ...
    def test_03_get_prods_by_le_price(self):
        p1 = ProductDto(1, 'StandardWidget', 5.1, 100, 10000)
        p2 = ProductDto(4, "StandardGrommet", 5.1, 34, 10000)
        expected = [p1, p2]
        p = ProductJsonDao()
